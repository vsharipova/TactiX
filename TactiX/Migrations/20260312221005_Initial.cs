        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    num_of_spots = table.Column<int>(type: "integer", nullable: false),
                    num_of_poppers = table.Column<int>(type: "integer", nullable: false),
                    num_of_plates = table.Column<int>(type: "integer", nullable: false),
                    alphas_count = table.Column<int>(type: "integer", nullable: false),
                    deltas_count = table.Column<int>(type: "integer", nullable: false),
                    charlies_count = table.Column<int>(type: "integer", nullable: false),
                    misses_count = table.Column<int>(type: "integer", nullable: false),
                    stage_time = table.Column<TimeSpan>(type: "interval", nullable: false),
                    briefing_data = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    alpha_diff = table.Column<decimal>(type: "numeric", nullable: false),
                    delta_diff = table.Column<decimal>(type: "numeric", nullable: false),
                    charlie_diff = table.Column<decimal>(type: "numeric", nullable: false),
                    miss_diff = table.Column<decimal>(type: "numeric", nullable: false),
                    hit_factor_diff = table.Column<decimal>(type: "numeric", nullable: false),
                    ...
                    MatchAnalysisId = table.Column<int>(type: "integer", nullable: true),
                    MatchAnalysisId1 = table.Column<int>(type: "integer", nullable: true),
                    MatchId = table.Column<int>(type: "integer", nullable: true),
                    MatchId1 = table.Column<int>(type: "integer", nullable: true),
                    TrainingAnalysisId = table.Column<int>(type: "integer", nullable: true),
                    TrainingAnalysisId1 = table.Column<int>(type: "integer", nullable: true),
                    UserId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.MatchAnalysisId,
                        principalSchema: "public",
                        principalTable: "match_analysis",
                        principalColumn: "match_analysis_id");
                    table.ForeignKey(
                        name: "FK_comparison_match_analysis_MatchAnalysisId1",
                        column: x => x.MatchAnalysisId1,
                        principalSchema: "public",
                        principalTable: "match_analysis",
                        principalColumn: "match_analysis_id");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.TrainingAnalysisId,
                        principalSchema: "public",
                        principalTable: "training_analysis",
                        principalColumn: "training_analysis_id");
                    table.ForeignKey(
                        name: "FK_comparison_training_analysis_TrainingAnalysisId1",
                        column: x => x.TrainingAnalysisId1,
                        principalSchema: "public",
                        principalTable: "training_analysis",
                        principalColumn: "training_analysis_id");
                    table.ForeignKey(
