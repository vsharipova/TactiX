...
namespace TactiX.Migrations
{
    ...
    [Migration("20260319002842_AddRemainingExercisesPart2")]
    partial class AddRemainingExercisesPart2
    {
            ...
            modelBuilder.Entity("TactiX.Models.Comparison", b =>
                {
                    ...
                    b.Property<int?>("MatchAnalysisId1")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("TrainingAnalysisId1")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TrainingAnalysisId1");

                    b.HasIndex("UserId");

                    b.ToTable("comparison", "public");
                });

            modelBuilder.Entity("TactiX.Models.Exercise", b =>
                {
            ...
            modelBuilder.Entity("TactiX.Models.MatchStage", b =>
                {
                    ...
                    b.Property<string>("BriefingData")
                        .HasColumnType("jsonb")
                        .HasColumnName("briefing_data");
            ...
            modelBuilder.Entity("TactiX.Models.Comparison", b =>
                {
                    ...
                    b.HasOne("TactiX.Models.MatchAnalysis", null)
                        .WithMany("ComparisonsAsBase")
                        .HasForeignKey("MatchAnalysisId");

                    b.HasOne("TactiX.Models.MatchAnalysis", null)
                        .WithMany("ComparisonsAsTarget")
                        .HasForeignKey("MatchAnalysisId1");
                    ...
                    b.HasOne("TactiX.Models.TrainingAnalysis", null)
                        .WithMany("ComparisonsAsBase")
                        .HasForeignKey("TrainingAnalysisId");

                    b.HasOne("TactiX.Models.TrainingAnalysis", null)
                        .WithMany("ComparisonsAsTarget")
                        .HasForeignKey("TrainingAnalysisId1");
            ...
            modelBuilder.Entity("TactiX.Models.TrainingAnalysis", b =>
                {
                    b.HasOne("TactiX.Models.Training", "Training")
                        .WithOne("Analysis")
                        .HasForeignKey("TactiX.Models.TrainingAnalysis", "TrainingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
